...
public class DssScript {
    ...
    public void execDssInit(String sConfigurationFile, String sAppSymbolFile, String sLogStylesheetFile) throws ScriptingException {
        ...
        env.setScriptTimeout(3000); // 不同芯片 DSS 初始化时间不同，需要根据实际情况调整超时时间
        ...
        session.flash.options.setString("FlashEraseSelection", "Entire Flash"); // Entire Flash, Necessary Sectors Only (for Program Load)
        session.flash.options.setString("FlashDownloadSetting", "Erase and Program"); // Erase and Program, Program Only, Verify Only

        // 如果芯片没有使能 CSM 加密，请注释下面几行代码，如果使能了 CSM 加密，请在下方填写密码，否则无法连接芯片
        // session.flash.options.setString("Z1CSMPSWD0", "FFFFFFFF");
        // session.flash.options.setString("Z1CSMPSWD1", "FFFFFFFF");
        // session.flash.options.setString("Z1CSMPSWD2", "56781234");
        // session.flash.options.setString("Z1CSMPSWD3", "74471331");
        // session.flash.performOperation("Z1Unlock");
    ...
    // @formatter:off
    // 编译
    // javac -encoding UTF-8 -classpath ".;C:/ti/ccs1281/ccs/ccs_base/DebugServer/packages/ti/dss/java/dss.jar" ./DssScriptFiles/TMS320F280013x/DssScript.java
    // 运行
    // java -classpath ".;C:/ti/ccs1281/ccs/ccs_base/DebugServer/packages/ti/dss/java/dss.jar;./DssScriptFiles" TMS320F280013x/DssScript
    // @formatter:on
    /**
    ...
    public static void main(String[] args) {
        ...
        try {
            dss.execDssInit("D:/CCS12/TestProjF2800132/TMS320F2800132.ccxml", "D:/CCS12/TestProjF2800132/APP.out", "D:/CCS12/TestProjF2800132/LogFileStylesheet.xsl");
            dss.execFlashProgram("D:/CCS12/TestProjF2800132/APP.out");
            dss.execDssReset();
            dss.execDssGo();
            dss.execDssDeinit();
